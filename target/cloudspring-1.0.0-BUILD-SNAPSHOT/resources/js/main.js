$( document ).ready( function() {
    ...
    $(".favorites").click(function(){
        ...
        // 별이 클릭 안되어 있다면
        if($(this).children("img").attr("src") == "/cloudSpring/img/star.png"){
            $(this).children("img").attr("src","/cloudSpring/img/star_fill.png");
            
        }
        // 별이 클릭 되어 있다면
        else{
            $(this).children("img").attr("src","/cloudSpring/img/star.png");
        }
    ...
    $("#task_btn_area .favorites").click(function(){
        ...
        for(let i=0; i<arr_folder.length; i++){
            ...
            $("#content1 .folder li:nth-child("+(arr_folder[i]+1)+")").find(".favorites img").attr("src", "/cloudSpring/img/star_fill.png");
            $("#content1 .folder li:nth-child("+(arr_folder[i]+1)+")").find(".favorites").css("display", "block");
            
        }
        for(let i=0; i<arr_file.length; i++){
            // console.log(arr_file[i]);
            $("#content1 .file li:nth-child("+(arr_file[i]+1)+")").find(".favorites img").attr("src", "/cloudSpring/img/star_fill.png");
    ...
    $(".favorite_this").click(function(){
        if($(".file li:nth-child("+(index+1)+")").find(".favorites img").attr("src") == "/cloudSpring/img/star_fill.png"){
            alert("즐겨찾기에서 제거 되었습니다.");
            $(".more").css("display","none");
            // 해당 인덱스 별 컬러 변경 후 고정
            $(".file li:nth-child("+(index+1)+")").find(".favorites img").attr("src", "/cloudSpring/img/star_fill.png")
    ...
    $('#content1 li').hover(function(){
        ...
        if($(this).find(".favorites img").attr("src") == "/cloudSpring/img/star_fill.png"){
